...
//				getConnection is a interface  class
			...
			String user="create table users2(id int Auto_increment primary key,name varchar(100),number int)";
			st.executeUpdate(user);
			System.out.println("Table users2 is created at mysql ");
			String val="insert into users2(name,number) values(?,?)";
