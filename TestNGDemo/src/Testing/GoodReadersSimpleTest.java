...
public class GoodReadersSimpleTest {
    ...
    public void signupAndLogin() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ap_customer_name"))).sendKeys("Korukonda Anusha");
        driver.findElement(By.id("ap_email")).sendKeys("anusha@gmail.com");
        driver.findElement(By.id("ap_password")).sendKeys("anu1223");
        driver.findElement(By.id("ap_password_check")).sendKeys("anu1223");
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ap_email"))).sendKeys("anusha@gmail.com");
        driver.findElement(By.id("ap_password")).sendKeys("anu1223");
