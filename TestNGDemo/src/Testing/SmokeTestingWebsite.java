...
public class SmokeTestingWebsite {
    ...
    public void registerNewUser() {
        ...
        driver.findElement(By.id("FirstName")).sendKeys("maxi");
        driver.findElement(By.id("LastName")).sendKeys("Blonde");
        driver.findElement(By.id("Email")).sendKeys("maxi@gmail.com");
        driver.findElement(By.id("Password")).sendKeys("maxi1234");
        driver.findElement(By.id("ConfirmPassword")).sendKeys("maxi1234");
